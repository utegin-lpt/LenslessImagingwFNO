...
We use a Fourier Neural Operator (FNO) to reconstruct DiffuserCam measurements. Because FNOs learn continuous function mappings, a single network trained at fixed resolution can reconstruct images at higher resolutions *without retraining*.
